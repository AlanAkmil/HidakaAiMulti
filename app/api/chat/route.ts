...
export const maxDuration = 300; // butuh Vercel Pro untuk >60s; di Hobby akan ke-cap 60s
  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        // 4. UI/UX + Anti-slop loop (max 2 revisi)
        ...
        // 7. Scraper logic (kalau task-nya scrape, generate parsing code juga)
        ...
        // 8. Assembler — gabung jadi satu index.html
