...
// dikirim ke browser. Tiap fungsi return { text, raw } biar orchestrator bisa
// log / debug kalau perlu.
...
/**
 * Groq — OpenAI-compatible chat completions (cepat, dipakai untuk agent
 * yang butuh respons instan: router, JS gen, assembler)
